          ...
          <Row className="justify-content-center mt-5">
            ...
            >
              <Row className="mb-3 justify-content-center">
                <Col md={6} className="signupContent border bg-white shadow p-5 pt-4">
                  <div className="row mt-3 mb-3 text-center">
                    <h3 className="loginform justify-content-center">Add your product</h3>
                  </div>
                  ...
                  <Form.Group as={Col} md="12" controlId="validationCustom06" className="mb-3">
                  ...
                  <label htmlFor="exampleCategory" className="form-label">Product category</label>
                  <select
